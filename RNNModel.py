...
from tensorflow.contrib.rnn import BasicRNNCell, BasicLSTMCell, OutputProjectionWrapper, DropoutWrapper
...
class RNNModel(object):
    ...
    def __init__(self, sequence_length, RNN_size):
        ...
        with tf.name_scope('output'):
            ...
            self.output = tf.nn.xw_plus_b(self.states.h, W, b)
